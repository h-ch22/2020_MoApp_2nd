...
public class AddFriend extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Toast.makeText(AddFriend.this, "기입된 사용자가 없습니다", Toast.LENGTH_SHORT).show();
                            }
                        } else {
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddFriend.this, activity_main.class);
        ...
        docfollower.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(AddFriend.this, "추가되었습니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if(document.getData().containsValue(checkID) == false) {
                            ...
                            Toast.makeText(AddFriend.this, "중복된친구입니다.", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Map<String, Long> Followingnum = new HashMap<>();
