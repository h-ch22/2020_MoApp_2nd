                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    Toast.makeText(activity_resetPassword.this, "비밀번호 재설정링크를 입력한 E-mail로 전송하였습니다.", Toast.LENGTH_SHORT).show();
                                }

                                else{
                                    Toast.makeText(activity_resetPassword.this, "E-mail을 재확인해주세요.\n문제가 계속 발생할 경우 관리자에게 문의해주세요.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
            }
