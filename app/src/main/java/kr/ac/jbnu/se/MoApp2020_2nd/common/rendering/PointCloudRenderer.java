 ...
 */
package kr.ac.jbnu.se.MoApp2020_2nd.common.rendering;
...
public class PointCloudRenderer {
  ...
  public void createOnGlThread(Context context) throws IOException {
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "before create");
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "buffer alloc");

    int vertexShader =
            kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, VERTEX_SHADER_NAME);
    int passthroughShader =
            kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, FRAGMENT_SHADER_NAME);
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "program");
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "program  params");
  }
  ...
  public void update(PointCloud cloud) {
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "before update");
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "after update");
  }
  ...
  public void draw(float[] cameraView, float[] cameraPerspective) {
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "Before draw");
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "Draw");
  }
}
