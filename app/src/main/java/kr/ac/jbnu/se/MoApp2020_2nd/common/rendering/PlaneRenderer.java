...
public class PlaneRenderer {
  ...
  public void createOnGlThread(Context context, String gridDistanceTextureName) throws IOException {
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "Program creation");
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "Texture loading");
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "Program parameters");
  }
  ...
  private void draw(float[] cameraView, float[] cameraPerspective, float[] planeNormal) {
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "Drawing plane");
  }
  ...
  public void drawPlanes(Collection<Plane> allPlanes, Pose cameraPose, float[] cameraPerspective) {
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "Setting up to draw planes");
    ...
    kr.ac.jbnu.se.MoApp2020_2nd.common.rendering.ShaderUtil.checkGLError(TAG, "Cleaning up after drawing planes");
  }
