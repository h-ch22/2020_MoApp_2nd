...
public class activity_Follower extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = intent.getExtras().getString("follower");
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        myfollwer = document.getLong("number").intValue();
                        for(int i = 1; i<myfollwer+1; i++){
    ...
    private void loadstory() {
        final LinearLayout topLL = findViewById(R.id.followerList);
        for(int i = 1; i<myfollwer+1; i++){
            ...
            name_1[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v ) {
                    Intent intent = new Intent(activity_Follower.this, ViewProfile.class);
