package kr.ac.jbnu.se.MoApp2020_2nd.rendering;

import android.opengl.Matrix;
import kr.ac.jbnu.se.MoApp2020_2nd.dialog_ARSettings;
...
public class LineUtils {
    ...
    public static Vector3f GetWorldCoords(Vector2f touchPoint, float screenWidth, float screenHeight, float[] projectionMatrix, float[] viewMatrix) {
        ...
        touchRay.direction.scale(dialog_ARSettings.getStrokeDrawDistance());
    ...
    public static boolean distanceCheck(Vector3f newPoint, Vector3f lastPoint) {
        ...
        if (temp.length() > dialog_ARSettings.getMinDistance()) {
            return true;
        }
        return false;
    }
